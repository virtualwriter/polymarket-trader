...
_Generated 2026-08-13T07:10:54Z_

## 1. Summary
- FIND records: 59 total (open 12, strengthened 30, weakened 0, negative 4)
- Research themes: 6
...
- #3 **FIND-0043** opp=0.9912 conf=0.612 | `ONE_TOUCH_HIGH_EDGE_NO|BTC|strat:dir=above,e3-8|no` | theme heatmap_one_touch
- #4 **FIND-0030** opp=0.9842 conf=0.4687 | `ONE_TOUCH_HIGH_EDGE_NO|ALL|strat:dir=above,e3-8|no` | theme heatmap_one_touch
...
- #7 **FIND-0058** opp=0.9727 conf=0.4345 | `ONE_TOUCH_HIGH_EDGE_NO|ALL|strat:s?,e3-8|no` | theme heatmap_one_touch
- #8 **FIND-0055** opp=0.9716 conf=0.4179 | `ONE_TOUCH_HIGH_EDGE_NO|BTC|strat:s?,e3-8|no` | theme heatmap_one_touch
...
## 3. Themes overview
- **THEME-0001** (heatmap_one_touch): 36 findings, avg opp 0.6583
...
- Opportunities export: 2026-08-13T07:10:53Z
- Findings export: 2026-08-13T07:09:21Z
- Themes export: 2026-08-13T07:09:24Z
