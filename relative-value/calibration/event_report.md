...
- Rows in log: 4599 | unique markets: 658
- Resolved markets (real UMA labels): 442 usable, 152 still open
- Gate-passed markets: resolved 19, still open 12
...
```
all resolved markets:    n=442 | NO-win  71.3% | avg   -2.10% | total   -929.1% | median NO entry 0.910
gate-passed (resolved):  n= 19 | NO-win  52.6% | avg  -24.85% | total   -472.1% | median NO entry 0.600
```

## By asset
```
OIL                    n=135 | NO-win  72.6% | avg   +5.46% | total   +737.0% | median NO entry 0.860
...
```
<0-0                   n=395 | NO-win  72.2% | avg   -2.25% | total   -888.3% | median NO entry 0.930
...
<5%                    n=104 | NO-win  29.8% | avg  -21.42% | total  -2227.6% | median NO entry 0.295
...
0-7d                   n= 85 | NO-win  81.2% | avg  -10.11% | total   -859.3% | median NO entry 0.980
```

## By contract type / direction
```
touch/above            n=215 | NO-win  73.0% | avg   -5.59% | total  -1201.4% | median NO entry 0.920
touch/below            n=187 | NO-win  67.9% | avg   -7.72% | total  -1443.2% | median NO entry 0.910
